...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("VesselManagerCoordinator");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("VesselManagerCoordinator");
        ...
        config.getMapConfigs().put("com.l2l.coordinator.vmc.domain.*", initializeDomainMapConfig(jHipsterProperties));
